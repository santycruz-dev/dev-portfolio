    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 w-full h-full pointer-events-auto">
          <Spline scene="https://prod.spline.design/R-s1XXxAWCNEIlBk/scene.splinecode" />
        </div>

        {/* Content Overlay */}
        <div className="relative z-10 container mx-auto h-full flex items-center pointer-events-none">
          <div className="max-w-4xl space-y-8 animate-fade-in animate-slide-up backdrop-blur-sm bg-background/20 p-8 rounded-lg pointer-events-auto">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl relative">
              I build modern, accessible, high-performance web experiences that
              connect with users and solve real problems.
            ...
            <div className="flex flex-wrap gap-4 pt-6">
              <Button
                size="lg"
                className="group relative overflow-hidden bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 transition-all duration-300"
                onClick={() => {
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-primary/20 hover:border-primary group"
                onClick={() => {
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(255,152,0,0.05) 0%, rgba(0,0,0,0) 85%)",
            filter: "blur(15px)",
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(255,152,0,0.03) 0%, rgba(0,0,0,0) 85%)",
            filter: "blur(12px)",
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(255,152,0,0.04) 0%, rgba(0,0,0,0) 85%)",
            filter: "blur(10px)",
      ...
      <section
        id="projects"
        className="py-20 relative overflow-hidden bg-gradient-to-br from-background via-background to-secondary/20"
      >
        ...
        <div className="container relative z-10">
          <div className="mb-16 max-w-2xl mx-auto text-center">
            ...
            <p className="text-muted-foreground">
              Innovative digital solutions designed for an ever-evolving
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(255,152,0,0.02) 0%, rgba(0,0,0,0) 85%)",
            filter: "blur(8px)",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border border-border/40 bg-card p-6 rounded-md group transition-all duration-300 hover:border-primary/30 relative overflow-hidden">
              ...
              <p className="text-muted-foreground mb-6 relative z-10">
                ...
                with modern frameworks like React, Next.js, and TypeScript.
              </p>
              <Link
                to="/services"
                className="text-primary text-sm hover:underline relative z-10"
              >
                Learn more
              </Link>
            </div>
            ...
            <div className="border border-border/40 bg-card p-6 rounded-md group transition-all duration-300 hover:border-primary/30 relative overflow-hidden">
              ...
              <p className="text-muted-foreground mb-6 relative z-10">
                Implementing blockchain solutions, smart contract integration,
                and decentralized applications with Ethereum, Solana, and more.
              </p>
              <Link
                to="/services"
                className="text-primary text-sm hover:underline relative z-10"
            ...
            <div className="border border-border/40 bg-card p-6 rounded-md group transition-all duration-300 hover:border-primary/30 relative overflow-hidden">
              ...
              <p className="text-muted-foreground mb-6 relative z-10">
                Designing intuitive user experiences and visually appealing
            ...
            <div className="border border-border/40 bg-card p-6 rounded-md group transition-all duration-300 hover:border-primary/30 relative overflow-hidden">
              ...
              <p className="text-muted-foreground mb-6 relative z-10">
                Improving application speed, responsiveness, and overall
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="border border-border/40 bg-card p-6 rounded-md flex flex-col md:flex-row gap-4 items-start">
              ...
              <div>
                <p className="text-muted-foreground mb-4 italic">
                  "The web application developed exceeded our expectations. The
                  attention to detail and performance optimization made a
                  significant difference in our user engagement metrics."
                </p>
            ...
            <div className="border border-border/40 bg-card p-6 rounded-md flex flex-col md:flex-row gap-4 items-start">
              ...
              <div>
                <p className="text-muted-foreground mb-4 italic">
                  "Working with this developer was a seamless experience. Their
                  expertise in Web3 technologies helped us launch our dApp ahead
                  of schedule with all the features we needed."
                </p>
                <h3 className="text-lg font-semibold mb-1">Michael Chen</h3>
                <p className="text-xs text-muted-foreground/70">
                  Founder, BlockChain Solutions
                </p>
              </div>
            </div>
          </div>
